...
const EmbeddedCourse = () => {
  ...
  const handleRegisterClick = () => {
    // Select the course automatically as requested
    const course = {
      id: "linux-rtos-embedded",
      ...
      <div>
        ...
        <section className="section-container justify-center text-center">
          ...
          <h1 className="heading">
            <span style={{ color: "#10899A" }}>Linux </span>
            <span style={{ }}>& </span>
            <span style={{ color: "#DE5769" }}>Real-Time Operating Systems </span>
            for Embedded <br />
            
          </h1>

          <div className="banner-wrap justify-center">
            <img src="/images/c3.1.jpg" alt="circuit" className="banner-img" />
            <img src="/images/c3.2.jpg" alt="chip" className="banner-img" />
          </div>
        ...
        <section className="section-container">
          ...
          <div className="two-col">
            <div>
              ...
              <p className="text-para">
                 Engineers moving to more complex systems (edge gateways, advanced devices).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-para">
               Comfortable with C, microcontroller fundamentals, and basic OS concepts.
              </p>
        ...
        <section className="section-container">
         <div className="lg:-mt-20 -mt-10">
          ...
          <ul className="two-col-list list-disc pl-4 marker:text-[#10899A] custom-bullet">
            <li>Build and deploy embedded Linux images (Yocto / Buildroot basics).</li>
            <li>Write kernel modules and user-space device interaction.</li>
            <li>Architect mixed-criticality systems with RTOS tasks and Linux.</li>
            <li>Use cross-toolchains, gdb, perf, and trace tools.</li>
          </ul>
        ...
        <section className="section-container">
          ...
          <br /> <br /><hr className="border-t-2 border-[#C2E8EA]" />
        </section>
  ...
  <div className="capstone-3col">
    ...
    <div className="capstone-item">
      ...
      <p className="text-para">
        Create a gateway that runs Linux and communicates with RTOS-based sensor nodes — show real-time constraints and end-to-end data pipeline.
      </p>
    </div>
    ...
    <div className="capstone-item">
      ...
      <ul className="list-disc pl-4 marker:text-[#10899A] custom-bullet">
        <li>Raspberry Pi / BeagleBone / custom ARM board</li>
        <li>Cross-toolchain (arm-none-eabi / aarch64)</li>
        <li>Yocto VirtualBox setup</li>
        <li>JTAG debugger</li>
      </ul>
    </div>
  </div>
        ...
        <div> 
            </div> <br /><hr className="border-t-2 border-[#C2E8EA]" />
        </section >
  ...
  <div className="capstone-item">
      ...
      <ul>
        ...
        Practical labs (60%), driver code & documentation (40%). Passing threshold 75%.
        </li>
      </ul>
      </div>
    </div>
...
const modules = [
  { title: "Module 1", desc: "Linux on ARM: boot flow, U-Boot, kernel image, DTB." },
  { title: "Module 2", desc: "Build systems: Yocto vs Buildroot, kernel config, rootfs." },
  { title: "Module 3", desc: "Device drivers and kernel modules (GPIO, char devices)." },
  { title: "Module 4", desc: "User-space device interaction, sysfs, and udev." },
  { title: "Module 5", desc: "FreeRTOS fundamentals: tasks, queues, ISR handling." },
  { title: "Module 6", desc: "Zephyr RTOS & modern embedded frameworks." },
  { title: "Module 7", desc: "Scheduling, priority inversion, and mutexes." },
  { title: "Module 8", desc: "Cross-debugging: gdbserver, ftrace, perf, and trace-cmd." },
  { title: "Module 9", desc: "Secure boot, signed kernels, and secure update." },
  { title: "Module 10", desc: "Final: integrate an RTOS sensor with an embedded Linux gateway." },
];