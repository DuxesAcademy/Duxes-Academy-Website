...
const EmbeddedCourse = () => {
      ...
      <div>
        ...
        <section className="section-container justify-center text-center">
          ...
          <h1 className="heading">
            <span style={{ color: "#10899A" }}>IoT </span>
            <span style={{ }}>& </span>
            <span style={{ color: "#DE5769" }}>Consumer Electronics </span>
            Design <br />
            
          </h1>

          <div className="banner-wrap justify-center">
            <img src="/images/c2.1.jpg" alt="circuit" className="banner-img" />
            <img src="/images/c2.2.jpg" alt="chip" className="banner-img" />
          </div>
          ...
          <div className="badge flex items-center gap-2">
            ...
            <span>10 Weeks (4–5 hrs/week)</span>
          </div>
        ...
        <section className="section-container">
          ...
          <div className="two-col">
            <div>
              ...
              <p className="text-para">
                Engineers building IoT prototypes or product teams.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-para">
               Course 1 or equivalent embedded experience; basic web/mobile knowledge helpful.
              </p>
        ...
        <section className="section-container">
         <div className="lg:-mt-20 -mt-10">
          ...
          <ul className="two-col-list list-disc pl-4 marker:text-[#10899A] custom-bullet">
            <li>Implement Wi-Fi/BLE/LoRa/NB-IoT connectivity; choose the right radio.</li>
            <li>Build an end-to-end pipeline: device → gateway → cloud → mobile app.</li>
            <li>Design OTA firmware update flow, secure device provisioning, and basic product testing.</li>
            <li>Understand BOM optimization, EMI/EMC basics, and certification considerations.</li>
          </ul>
  ...
  <div className="capstone-3col">
    ...
    <div className="capstone-item">
      ...
      <p className="text-para">
        Ship a Wi-Fi/BLE-enabled consumer prototype with cloud telemetry and a simple mobile dashboard; include OTA update demo.
      </p>
    </div>
    ...
    <div className="capstone-item">
      ...
      <ul className="list-disc pl-4 marker:text-[#10899A] custom-bullet">
        <li>ESP32 Devkit</li>
        <li>Nordic nRF52840 & breadboard sensors</li>
        <li>Cloud free tiers</li>
        <li>Mobile demo framework</li>
    ...
    <div className="capstone-item">
      ...
      <ul>
        <li className="flex items-center gap-2">
          ...
          Project-based milestone checks (70%) + documentation and demo (30%).
        </li>
      </ul>
      </div>
    </div>
        ...
        <div className="section-container">
          <div className="flex justify-center  lg:-mt-28 -mt-10">
            <button
              onClick={() =>
                handleRegisterClick({
                  id: "iot-consumer-electronics-design",
...
const modules = [
  { title: "Module 1", desc: "IoT ecosystem & connectivity selection (Wi-Fi, BLE, Thread, LoRa)." },
  { title: "Module 2", desc: "ESP32/NRF/LPWAN basics and radio stacks." },
  { title: "Module 3", desc: "MQTT, CoAP, REST — protocols and message patterns." },
  { title: "Module 4", desc: "Cloud integration: AWS IoT / Azure IoT / Google IoT (conceptual)." },
  { title: "Module 5", desc: "Mobile-app basics for device control (React Native / Flutter overview)." },
  { title: "Module 6", desc: "OTA design, firmware authenticity & rollback strategies." },
  { title: "Module 7", desc: "Security fundamentals: TLS, key provisioning, secure storage." },
  { title: "Module 8", desc: "Power & BOM tradeoffs for consumer devices." },
  { title: "Module 9", desc: "Manufacturing readiness: test fixtures, DFx, certification checklist." },
  { title: "Module 10", desc: "Final product demo & go-to-market considerations." },
];