...
const EmbeddedCourse = () => {
  ...
  const handleRegisterClick = () => {
    const course = {
      id: "automotive-embedded-development",
      ...
      <div>
        ...
        <section className="section-container justify-center text-center">
          ...
          <h1 className="heading">
            <span style={{ color: "#10899A" }}>Automotive </span>
            <span style={{ color: "#DE5769" }}>Embedded </span>
            Development <br />
            
          </h1>

          <div className="banner-wrap justify-center">
            <img src="/images/c4.1.jpg" alt="circuit" className="banner-img" />
            <img src="/images/c4.2.jpg" alt="chip" className="banner-img" />
          </div>
          ...
          <div className="badge flex items-center gap-2">
            ...
            <span> 8–12 weeks (5 hrs/week)</span>
          </div>
            ...
            <div className="badge flex items-center gap-2">
              ...
              <span>Intermediate → Advanced</span></div>
           </div>
        ...
        <section className="section-container">
          ...
          <div className="two-col">
            <div>
              ...
              <p className="text-para">
                 Engineers targeting automotive OEMs/suppliers.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-para">
               Embedded C, RTOS knowledge, and basic electronics.
              </p>
        ...
        <section className="section-container">
         <div className="lg:-mt-20 -mt-10">
          ...
          <ul className="two-col-list list-disc pl-4 marker:text-[#10899A] custom-bullet">
            <li>Work with CAN/CAN-FD, LIN, FlexRay, and diagnostics (UDS).</li>
            <li>Understand AUTOSAR layered architecture and basic workflow.</li>
            <li>Recognize and implement functional safety concepts (ISO 26262).</li>
            <li>Design deterministic real-time software and diagnostic-capable systems.</li>
          </ul>
  ...
  <div className="capstone-3col">
    ...
    <div className="capstone-item">
      ...
      <p className="text-para">
         Build a CAN bus network of 2–3 nodes (e.g., sensor ECU + actuator ECU) demonstrating UDS readout and an OTA-safe update simulation.
      </p>
    </div>
    ...
    <div className="capstone-item">
      ...
      <ul className="list-disc pl-4 marker:text-[#10899A] custom-bullet">
        <li>CAN transceiver dev boards (MCP2515/STM32 with CAN)</li>
        <li>OBD-II interface adapters</li>
        <li>CAN analyzers (PCAN, Peak)</li>
        <li>Vector-style trace logs (software alternatives)</li>
        <li>AUTOSAR learning resources.</li>
      </ul>
    </div>
      ...
      Lab projects + safety case writeup (pass mark 75%). Optional extra certificate for ISO 26262 primer when doing extra reading.
...
const modules = [
  { title: "Module 1", desc: "Automotive bus systems: CAN, CAN-FD, LIN overview." },
  { title: "Module 2", desc: "CAN stack, frames, filters, and bus sniffing tools." },
  { title: "Module 3", desc: "Diagnostic communication: UDS basics and ECU concepts." },
  { title: "Module 4", desc: "AUTOSAR fundamentals: Classic vs Adaptive." },
  { title: "Module 5", desc: "Safety basics: ISO 26262 introduction and safety lifecycle." },
  { title: "Module 6", desc: "Functional safety techniques: redundancy, diagnostics, and watchdogs." },
  { title: "Module 7", desc: "Real-time design patterns for automotive systems." },
  { title: "Module 8", desc: "Hardware and EMC considerations, ruggedization." },
  { title: "Module 9", desc: "Over-the-air concerns and secure updates in vehicle context." },
  { title: "Module 10", desc: "Final case study: develop a CAN-based ECU demo with diagnostics." },
];