        ...
        <section className="section-container justify-center text-center">
          <div className="lg:-mt-16 -mt-10">
            <h1 className="heading">
              <span style={{ color: "#10899A" }}>Low-Power Design</span>
              <span style={{ }}> & </span>
              <span style={{ color: "#DE5769" }}>Wireless Systems </span>
              <br />
            </h1>

            <div className="banner-wrap justify-center">
              <img src="/images/c5.1.jpg" alt="circuit" className="banner-img" />
              <img src="/images/c5.2.jpg" alt="chip" className="banner-img" />
            </div>
          </div>
          <div className="badge-row justify-center">
            <div className="badge flex items-center gap-2">
              ...
              <span>  6–8 weeks (3–4 hrs/week)</span>
            </div>
          ...
          <div className="lg:-mt-24 -mt-10">
            <div className="two-col">
              <div>
                ...
                <p className="text-para">
                  IoT/edge engineers working on battery-operated or remote devices.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-para">
                  Embedded fundamentals, basic RF understanding helpful.
                </p>
              </div>
            </div>
        ...
        <section className="section-container">
          <div className="lg:-mt-20 -mt-10">
            ...
            <ul className="two-col-list list-disc pl-4 marker:text-[#10899A] custom-bullet">
              <li>Design firmware that achieves months-to-years battery life. (UDS).</li>
              <li>Implement deep-sleep strategies, duty-cycle optimizations, and wake sources.</li>
              <li>Use LPWANs (LoRaWAN, NB-IoT) and BLE long-range strategies.</li>
              <li>Understand PCB/layout & power management IC selection for low-power.</li>
            </ul>
          </div>
          <br /> <hr className="border-t-2 border-[#C2E8EA]" />
        </section>
            ...
            <div className="grid gap-10" style={{ gridTemplateColumns: "1fr", marginTop: "20px" }}>
              ...
              <div className="capstone-3col">
                ...
                <div className="capstone-item">
                  ...
                  <p className="text-para">
                    Create a LoRa battery-powered sensor that transmits weekly and demonstrates multi-month battery life with power logs.
                  </p>
                </div>
                ...
                <div className="capstone-item">
                  ...
                  <ul className="list-disc pl-4 marker:text-[#10899A] custom-bullet">
                    <li>Low-power MCUs (STM32L, nRF52)</li>
                    <li>LoRa dev kit</li>
                    <li>Power profiler (Monsoon or INA-based)</li>
                    <li>Bench PSU</li>
                    <li>Coin-cell holders</li>
                  </ul>
                </div>
              </div>
            </div>
          </div>
          <div><br /><hr className="border-t-2 border-[#C2E8EA]" /></div>
        </section>
            ...
            <div className="lg:-mt-24 -mt-16">
              ...
              <ul>
                <li className="flex items-center gap-2 mb-4">
                  ...
                  Lab reports with measured battery-life results (70%) + final report (30%).
                </li>
              </ul>
            </div>
          </div>
...
const modules = [
  { title: "Module 1", desc: "Power budgeting and measurement techniques." },
  { title: "Module 2", desc: "MCU low-power modes and wake-sources (timers, external interrupts)." },
  { title: "Module 3", desc: "Sensor sampling strategies and duty-cycle optimization." },
  { title: "Module 4", desc: "Energy harvesters, PMICs, and supercapacitor basics." },
  { title: "Module 5", desc: "LPWAN overview: LoRaWAN architecture & NB-IoT basics." },
  { title: "Module 6", desc: "BLE low energy patterns and long-range tradeoffs." },
  { title: "Module 7", desc: "PCB layout tips for low-power & antenna basics." },
  { title: "Module 8", desc: "Field testing, reliability, and power profiling." },
];